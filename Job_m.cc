...
// Packing/unpacking an std::list
	...
	void doParsimPacking(omnetpp::cCommBuffer *buffer,
		...
		for (typename std::list<T, A>::const_iterator it = l.begin();
				it != l.end(); ++it)
...
// Packing/unpacking an std::set
	...
	template<typename T, typename Tr, typename A>
	void doParsimUnpacking(omnetpp::cCommBuffer *buffer,
			std::set<T, Tr, A>& s) {
		int n;
		doParsimUnpacking(buffer, n);
		for (int i = 0; i < n; i++) {
...
namespace {
	template<class T> inline typename std::enable_if<
			std::is_polymorphic<T>::value
					&& std::is_base_of<omnetpp::cObject, T>::value, void *>::type toVoidPtr(
			T* t) {
	...
	template<class T> inline typename std::enable_if<
			!std::is_polymorphic<T>::value, void *>::type toVoidPtr(T* t) {
...
// operator<< for std::vector<T>
	...
	Job_Base::Job_Base(const char *name, short kind) :
			::omnetpp::cMessage(name, kind) {
	}

	Job_Base::Job_Base(const Job_Base& other) :
	...
	JobDescriptor::JobDescriptor() :
			omnetpp::cClassDescriptor("queueing::Job", "omnetpp::cMessage") {
	...
	unsigned int JobDescriptor::getFieldTypeFlags(int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldTypeFlags(
					field);
			field -= basedesc->getFieldCount();
		}
		static unsigned int fieldTypeFlags[] = { FD_ISEDITABLE, // FIELD_priority
	...
	const char *JobDescriptor::getFieldName(int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldName(
					field);
			field -= basedesc->getFieldCount();
		}
		static const char *fieldNames[] = { "priority", "totalQueueingTime",
				"totalServiceTime", "totalDelayTime", "queueCount",
				"delayCount", "generation", };
	...
	int JobDescriptor::findField(const char *fieldName) const {
		...
		if (fieldName[0] == 'p' && strcmp(fieldName, "priority") == 0) return base
				+ 0;
		if (fieldName[0] == 't' && strcmp(fieldName, "totalQueueingTime") == 0) return base
				+ 1;
		if (fieldName[0] == 't' && strcmp(fieldName, "totalServiceTime") == 0) return base
				+ 2;
		if (fieldName[0] == 't' && strcmp(fieldName, "totalDelayTime") == 0) return base
				+ 3;
		if (fieldName[0] == 'q' && strcmp(fieldName, "queueCount") == 0) return base
				+ 4;
		if (fieldName[0] == 'd' && strcmp(fieldName, "delayCount") == 0) return base
				+ 5;
		if (fieldName[0] == 'g' && strcmp(fieldName, "generation") == 0) return base
				+ 6;
	...
	const char *JobDescriptor::getFieldTypeString(int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldTypeString(
					field);
			field -= basedesc->getFieldCount();
		}
		static const char *fieldTypeStrings[] = { "int",    // FIELD_priority
	...
	const char **JobDescriptor::getFieldPropertyNames(int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldPropertyNames(
					field);
			field -= basedesc->getFieldCount();
		}
		switch (field) {
	...
	const char *JobDescriptor::getFieldProperty(int field,
			const char *propertyname) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldProperty(
					field, propertyname);
			field -= basedesc->getFieldCount();
		}
		switch (field) {
	...
	int JobDescriptor::getFieldArraySize(void *object, int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldArraySize(
					object, field);
			field -= basedesc->getFieldCount();
		}
		Job_Base *pp = (Job_Base *) object;
		(void) pp;
		switch (field) {
			default:
				return 0;
	...
	const char *JobDescriptor::getFieldDynamicTypeString(void *object,
			int field, int i) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldDynamicTypeString(
					object, field, i);
			field -= basedesc->getFieldCount();
		}
		Job_Base *pp = (Job_Base *) object;
	...
	std::string JobDescriptor::getFieldValueAsString(void *object, int field,
			int i) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldValueAsString(
					object, field, i);
			field -= basedesc->getFieldCount();
		}
		Job_Base *pp = (Job_Base *) object;
		...
		switch (field) {
			...
			case FIELD_totalQueueingTime:
				return simtime2string(pp->getTotalQueueingTime());
			case FIELD_totalServiceTime:
				return simtime2string(pp->getTotalServiceTime());
			case FIELD_totalDelayTime:
				return simtime2string(pp->getTotalDelayTime());
			case FIELD_queueCount:
				return long2string(pp->getQueueCount());
			case FIELD_delayCount:
				return long2string(pp->getDelayCount());
			case FIELD_generation:
				return long2string(pp->getGeneration());
			default:
				return "";
		}
	}

	bool JobDescriptor::setFieldValueAsString(void *object, int field, int i,
			const char *value) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->setFieldValueAsString(
		...
		switch (field) {
			case FIELD_priority:
				...
				return true;
			case FIELD_queueCount:
				pp->setQueueCount(string2long(value));
				return true;
			case FIELD_delayCount:
				pp->setDelayCount(string2long(value));
				return true;
			case FIELD_generation:
				pp->setGeneration(string2long(value));
				return true;
			default:
				return false;
		}
	...
	const char *JobDescriptor::getFieldStructName(int field) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldStructName(
					field);
			field -= basedesc->getFieldCount();
		}
		switch (field) {
	...
	void *JobDescriptor::getFieldStructValuePointer(void *object, int field,
			int i) const {
		omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
		if (basedesc) {
			if (field < basedesc->getFieldCount()) return basedesc->getFieldStructValuePointer(
					object, field, i);
			field -= basedesc->getFieldCount();
		}
		Job_Base *pp = (Job_Base *) object;
